...
const password = (value) => bcrypt.hashSync(value, 10);
...
export const subjects = [
  { id: "physics-9-10", gradeId: "class-9-10", title: "Physics", order: 1 },
  { id: "chemistry-9-10", gradeId: "class-9-10", title: "Chemistry", order: 2 },
  { id: "math-9-10", gradeId: "class-9-10", title: "Mathematics", order: 3, status: "planned" },
  { id: "higher-math-9-10", gradeId: "class-9-10", title: "Higher Mathematics", order: 4, status: "planned" },
  { id: "biology-9-10", gradeId: "class-9-10", title: "Biology", order: 5, status: "planned" }
];
